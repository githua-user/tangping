import { GameState, Position, Door, BED_MAX_LEVEL, DOOR_MAX_LEVEL, GHOST_SPAWN_DURATION, TURRET_MAX_LEVEL } from '../types';
import { GHOST_ATTACK_OFFSET_Y, GRID_CELL_SIZE, GRID_OFFSET, ROOM_ORIGINS, ROOM_OUTLINES, ROOM_DOOR_GAP, WALL_BODY_WIDTH, WALL_LEAN_FRONT, roomIndexOf } from '../engine/Collision';
...
// 已建造物件的外观绘制（房门/床铺/炮塔）：只读 GameState 与引擎时钟，不回写游戏状态。
...
// Renderer 侧（玩家/幽灵血条等）与本类的床/炮塔铭牌共用
